                    ...
                    <div class="col-sm-4">
                        <select name="usertype" id="basic" class="selectpicker show-tick form-control" data-live-search="true">
								...
								<option value="Agents" @if($user->usertype=='Agents') selected @endif>{{trans('words.agent')}}</option>
                                 ...
                                 <option value="Seller" @if($user->usertype=='Seller') selected @endif>Seller</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="sellertype" id="basic" class="selectpicker show-tick form-control" data-live-search="true">
                                @if(isset($user->sellertype))

                                <option value="individual" @if($user->sellertype=='individual') selected @endif>Individual / Personal Sales A/C</option>
                                <option value="company" @if($user->sellertype=='company') selected @endif>Company Sales A/C</option>
