               ...
               <!-- <div class="avatar">
                ...
                {!! Form::open(array('url' => 'admin/login','class'=>'','id'=>'loginform','role'=>'form')) !!}
                        ...
                        <div class="form-group margin-none">
                            <div class="media">
                                ...
                                <div class="media-right media-middle">
                                    <a href="{{ URL::to('password/email') }}" class="small pull-right">{{trans('words.forgot')}}</a>
                                </div>
                            </div>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary">{{trans('words.sign_in')}} <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!} 
            </div>
