@extends("app")
@section('head_title', trans('words.properties').' | '.getcong('site_name') )
                ...
                <div class="col-xs-7 col-sm-7">  
                  <div class="bottom-sec column-view">
                    ...
                    <ul class="service-contacts list-inline clearfix">
                        ...
                        <li><a href="{{ url('properties/'.$property->property_slug.'/'.$property->id) }}" class="btn fly-btn2"><i class="fa fa-envelop"></i> EMAIL US</a></li>
                    </ul>
