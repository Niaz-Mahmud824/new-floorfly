    ...
    <div class="col-lg-9 col-md-9 min_form">
      ...
      <div class="table-responsive properties_min">
        ...
        {!! Form::open(array('url' => 'plan_send','class'=>'','id'=>'myProfile','role'=>'form')) !!} 
                  ...
                  <label for="payment" class="control-label"><h4>{{trans('words.payment_method')}}</h4></label>
                      ...
                      <div class="payment">
                       ...
                       <div class="payment-tab">
                          <div class="payment-tab-trigger">
                              ...
                              <label for="paypal">Paypal &nbsp;<img class="payment-logo paypal" src="{{ URL::asset('upload/paypal-logo.png')}}" alt="" width="60"></label> 
                      ...
                      <div class="payment-tab">
                          <div class="payment-tab-trigger">
                              ...
                              <label for="stripe">Stripe &nbsp;<img class="payment-logo stripe" src="{{ URL::asset('upload/stripe-logo.png')}}" alt="" width="60"></label> 
                          </div>
     
                      </div>
                      @endif

                       @if(getcong('paypal_payment_on_off')==0 AND getcong('stripe_payment_on_off') == 0)
               ...
               @if(getcong('paypal_payment_on_off') OR getcong('stripe_payment_on_off'))  
               <div class="form-group col-md-12">
                <div class="center mb20" align="center">
                    <button class="btn btn-primary btn-xl" type="submit">{{trans('words.select_plan')}}</button>
                </div>
               </div>  
               @endif            
