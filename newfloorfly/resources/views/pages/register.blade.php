        ...
        <div  class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div id="login-form" class="login-form">
                    <h2 class="hsq-heading type-1">{{'Register as Seller'}}</h2>
                        ...
                        <form class="mregisterform" action="{{ url('register') }}" method="POST">
                        {{ csrf_field() }} 
                        ...
                        <div class="tab-content">
                             <div role="tabpanel" class="tab-pane active" id="personal_tab">
                                <div class="content-box">
                                    <div class="form-group agr-fields">
                                        <input type="text" class="form-control" placeholder="{{trans('words.name')}} *" name="name" id="name" value="{{ old('name') }}"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group agr-fields">
                                                <input type="number" class="form-control" placeholder="{{trans('words.phone')}} *" name="phone" id="phone" minlength="11" maxlength="14" value="{{ old('phone') }}"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group agr-fields">
                                                <input type="email" class="form-control" placeholder="{{trans('words.email')}} *" name="email" id="email" maxlength="80" value="{{ old('email') }}" autocomplete="off" />
                             ...
                             <div role="tabpanel" class="tab-pane" id="verification_tab">
                                <div class="content-box">
                                    ...
                                    <div class="form-group agr-fields">
                                        <input type="number" class="form-control" placeholder="Verification Code *" name="verification_code" id="verify" value="{{ old('verification_code') }}"/>
                             ...
                             <div role="tabpanel" class="tab-pane" id="seller_info_tab">
                                 <div class="content-box">
                                    ...
                                    <div class="row individual select_box" id="individual" style="display:block">
                                        <div class="col-md-6">
                                            <div class="form-group agr-fields">
                                                <input type="text"  class="form-control" placeholder="{{'Present Address'}} *" name="seller_present_address" id="present_address" value="{{ old('seller_present_address') }}"/>
                                                <span id="present_address_error"></span>
                                                @if ($errors->has('seller_present_address'))
                                                    <span style="color:#fb0303">
                                                    {{ $errors->first('seller_present_address') }}
                                                    </span>
                                                @endif 
                                            </div>  
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group agr-fields">
                                                <input type="text"  class="form-control" placeholder="{{'Permanent Address'}} *" name="seller_permanent_address" id="permanent_address" value="{{ old('seller_permanent_address') }}"/>
                                                <span id="permanent_address_error"></span>
                                                @if ($errors->has('seller_permanent_address'))
                                                    <span style="color:#fb0303">
                                                        {{ $errors->first('seller_permanent_address') }}
                                                    </span>
                                                @endif 
                                            </div>
                                        </div> 
                                    ...
                                    <div class="row company select_box" id="company" style="display:none">
                                        <div class="col-md-6">
                                            <div class="form-group agr-fields">
                                                <input type="text"  class="form-control" placeholder="{{'Company Name'}} *" name="company_address" id="company_name" value="{{ old('company_address') }}"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group agr-fields">
                                                <input type="text"  class="form-control" placeholder="{{'Company Trade License'}} *" name="company_trade_license" id="company_trade_license" value="{{ old('company_trade_license') }}"/>
                                                <span id="company_trade_license_error"></span>
                                                @if ($errors->has('company_trade_license'))
                                                    <span style="color:#fb0303">
                                                        {{ $errors->first('company_trade_license') }}
                                                    </span>
                                                @endif 
                                            </div> 
                                        </div>
                                    ...
                                    <div class="search-button-container button-box">
                                        <button class="btn seller_click" id="floatReducing">{{trans('words.sign_up')}}</button>
                                    </div>

                                    <br/>&nbsp;

                                    <div class="search-fields" style="font-size: 15px; color:#fff">                            
                                        <p>{{trans('words.do_you_have_account')}} <a style="color:#ecc807" href="{{ url('login') }}">{{trans('words.login_here')}}</a> </p>
                                    </div>
                                </div>
