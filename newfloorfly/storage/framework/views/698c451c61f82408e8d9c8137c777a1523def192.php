...
<div class="field-row">
                ...
                <div class="field-row clearfix">
                    ...
                    <div class="col-xs-6">
                      <select id="p-bedroom" name="floor">
                        ...
                        <option value="11th" <?php if(old('floor')=='11th'): ?> selected <?php endif; ?>>11th</option>
                        <option value="12th" <?php if(old('floor')=='12th'): ?> selected <?php endif; ?>>12th</option>
                        <option value="13th" <?php if(old('floor')=='13th'): ?> selected <?php endif; ?>>13th</option>
                        <option value="14th" <?php if(old('floor')=='14th'): ?> selected <?php endif; ?>>14th</option>
                        <option value="15th" <?php if(old('floor')=='15th'): ?> selected <?php endif; ?>>15th</option>
                        <option value="16th" <?php if(old('floor')=='16th'): ?> selected <?php endif; ?>>16th</option>
                        <option value="17th" <?php if(old('floor')=='17th'): ?> selected <?php endif; ?>>17th</option>
                        <option value="18th" <?php if(old('floor')=='18th'): ?> selected <?php endif; ?>>18th</option>
                        <option value="19th" <?php if(old('floor')=='19th'): ?> selected <?php endif; ?>>19th</option>
                        <option value="20th" <?php if(old('floor')=='20th'): ?> selected <?php endif; ?>>20th</option>
                        <option value="21th" <?php if(old('floor')=='21th'): ?> selected <?php endif; ?>>21th</option>
                        <option value="22th" <?php if(old('floor')=='22th'): ?> selected <?php endif; ?>>22th</option>
                      </select>
                    </div>
                ...
                <div class="field-row clearfix">
                  ...
                  <div class="col-xs-6">
                    <select id="facing" name="facing">
                      ...
                      <option value="North-East" <?php if(old('facing')=='North-East'): ?> selected <?php endif; ?>>North-East</option>
                      <option value="North-West" <?php if(old('facing')=='North-West'): ?> selected <?php endif; ?>>North-West</option>
                      <option value="South-East" <?php if(old('facing')=='South-East'): ?> selected <?php endif; ?>>South-East</option>
                      <option value="South-West" <?php if(old('facing')=='South-West'): ?> selected <?php endif; ?>>South-West</option>
                    </select>
                  </div>
                ...
                <div class="field-row clearfix">
                  <div class="col-xs-6">
                    <select id="no_of_floor" name="no_of_floor">
                      ...
                      <option value="G+9" <?php if(old('no_of_floor')=='G+9'): ?> selected <?php endif; ?>>G+9</option>
                      <option value="G+10" <?php if(old('no_of_floor')=='G+10'): ?> selected <?php endif; ?>>G+10</option>
                      <option value="G+11" <?php if(old('no_of_floor')=='G+11'): ?> selected <?php endif; ?>>G+11</option>
                      <option value="G+12" <?php if(old('no_of_floor')=='G+12'): ?> selected <?php endif; ?>>G+12</option>
                      <option value="G+13" <?php if(old('no_of_floor')=='G+13'): ?> selected <?php endif; ?>>G+13</option>
                      <option value="G+14" <?php if(old('no_of_floor')=='G+14'): ?> selected <?php endif; ?>>G+14</option>
                      <option value="G+15" <?php if(old('no_of_floor')=='G+15'): ?> selected <?php endif; ?>>G+15</option>
                      <option value="G+16" <?php if(old('no_of_floor')=='G+16'): ?> selected <?php endif; ?>>G+16</option>
                      <option value="G+17" <?php if(old('no_of_floor')=='G+17'): ?> selected <?php endif; ?>>G+17</option>
                      <option value="G+18" <?php if(old('no_of_floor')=='G+18'): ?> selected <?php endif; ?>>G+18</option>
                      <option value="G+19" <?php if(old('no_of_floor')=='G+19'): ?> selected <?php endif; ?>>G+19</option>
                      <option value="G+20" <?php if(old('no_of_floor')=='G+20'): ?> selected <?php endif; ?>>G+20</option>
                      <option value="G+21" <?php if(old('no_of_floor')=='G+21'): ?> selected <?php endif; ?>>G+21</option>
                      <option value="G+22" <?php if(old('no_of_floor')=='G+22'): ?> selected <?php endif; ?>>G+22</option>
                    </select>
                  </div>
       ...
       <div class="b-sec" align="center"><br>
          <button type="submit" class="btn btn-lg submit"><?php echo e('SUBMIT NOW'); ?></button>
        </div>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/pages/add_property.blade.php ENDPATH**/ ?>