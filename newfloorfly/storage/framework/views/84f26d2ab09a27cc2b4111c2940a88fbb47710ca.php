      ...
      <div class="widget member-card">
        <div class="member-card-header">
          <a href="Javascript::void();" class="member-card-avatar">
            <!--  <?php if(Auth::user()->profile_image AND file_exists(public_path('upload/profile_image/'.Auth::user()->profile_image.'-s.jpg'))): ?>          
            <img src="<?php echo e(URL::asset('upload/profile_image/'.Auth::user()->profile_image.'-s.jpg')); ?>" alt="">
            <?php else: ?>
...
<?php endif; ?> 
    ...
    </div><?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/_particles/sidebar_user.blade.php ENDPATH**/ ?>