          ...
          <div class="information-box">
            ...
            <div class="box-content">
              ...
              <div class="field-row">
                  ...
                  <div class="field-row">
                    <input type="text" placeholder="<?php echo e(trans('words.location')); ?>" name="location" id="location" value="<?php echo e($property->location); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\floorfly\resources\views/pages/edit_property.blade.php ENDPATH**/ ?>