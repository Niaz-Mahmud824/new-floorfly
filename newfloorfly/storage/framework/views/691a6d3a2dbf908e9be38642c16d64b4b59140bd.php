            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label"><?php echo e(trans('words.property_type')); ?></label>
                      <div class="col-sm-9">
                        <input type="text" name="property_type" value="<?php echo e(isset($type->types) ? $type->types : null); ?>" class="form-control">
                    </div>
                </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\floorfly\resources\views/admin/pages/addedittypes.blade.php ENDPATH**/ ?>