...
<?php $__currentLoopData = $scategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             ...
                             <option value="  <?php echo e($category->id); ?>" <?php if(isset($service)): ?> <?php if($category->id==$service->category_id): ?>
                        selected
  ...
  <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <option value="<?php echo e($subcategory->id); ?>"<?php if(isset($service)): ?> <?php if($subcategory->id==$service->subcategory_id): ?>
                        selected
...
<?php $__currentLoopData = $childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <option value="<?php echo e($childcategory->id); ?>"<?php if(isset($service)): ?> <?php if($childcategory->id==$service->childcategory_id): ?>
                        selected
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/admin/pages/services/edit.blade.php ENDPATH**/ ?>