        ...
        <div class="row">
          <div class="col-xs-6 nopadding2">
            <div class="form-group agr-fields">
              <input type="text" class="form-control" placeholder="<?php echo e(trans('words.search_placeholder')); ?>" name="location" id="keyword">
            </div>
          </div>
...
<?php /**PATH D:\xmapp\htdocs\floorfly4\resources\views/_particles/search.blade.php ENDPATH**/ ?>