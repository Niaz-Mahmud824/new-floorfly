  ...
  <section class="main-container container">
      ...
      <div class="property-summery">
            ...
            <div class="bottom-sec ">
              ...
              <div class="property-address location-i"><i class="fa fa-map-marker"></i> <?php echo e(getPropertyLocationName($property->location)->name); ?></div>
                     ...
                     <div class="table-responsive">
                          <table class="table quick-peek">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>Location: </td>
                                <td><b><?php echo e(getPropertyLocationName($property->location)->name); ?> </b></td>
                              </tr>
              ...
              <div class="mdl-card__supporting-text">
                ...
                ?>
                  ...
                  <label class="" for="sample4">Total Price</label>
                    <input  type="text" class="form-control total_price" pattern="-?[0-9]*(\.[0-9]+)?" id="property_price" min="1" max="<?php echo e($pro_price); ?>" value="<?php echo e($pro_price); ?>"  tabindex="1">
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/pages/single_properties.blade.php ENDPATH**/ ?>