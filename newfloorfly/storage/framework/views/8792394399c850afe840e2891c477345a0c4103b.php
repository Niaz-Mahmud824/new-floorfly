                  ...
                  <div class="dropdown_number_list size_dropdown" id="size-dropdwon-sub" style="display:none">
                    ...
                    <div class="drop_left_box">
                      <div class="input_value1">
                          <input type="number" class="form-contorl input-border" id="get_min_data_value" name="get_min_data_value"/>
                      </div>
                    ...
                    <div class="drop_rigth_box">
                        <div class="input_value1">
                           <input type="number" class="form-contorl input-border" id="get_max_data_value" name="get_max_data_value"/>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\newfloorfly\resources\views/_particles/search.blade.php ENDPATH**/ ?>