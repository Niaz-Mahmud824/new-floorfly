            ...
            <form action="<?php echo e(route('service.update',['id'=>$service->id])); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <select name="service_category_id" id="pcategory" class="form-control input-lg dynamic">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <select name="service_childcategory_id" id="childcategory" class="form-control input-lg">
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\floorfly\resources\views/admin/pages/services/edit.blade.php ENDPATH**/ ?>