<div class="sidebar-box" id="contact-agent">
                    ...
                    <div class="agent-top">
                        <div class="agent-image">
                          <?php if($agent->profile_image): ?>
                            <img src="<?php echo e(URL::asset('upload/profile_image/$agent->profile_image')); ?>" alt="<?php echo e($agent->name); ?>">
                          <?php else: ?>
                          
                          <img src="<?php echo e(URL::asset('site_assets/img/male-avatar.png')); ?>" alt="<?php echo e($agent->name); ?>">
                        ...
                        <div class="agent-contacts">
                            <ul class="list-inline agent-contact-list">
                                <li class="agent-phone"><a href="tel:+88<?php echo e($agent->phone); ?>"><i class="fa fa-phone"></i></a></li>
                                <li class="agent-whatsapp"><a href="https://wa.me/<?php echo e($agent->phone); ?>"><i class="fa fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    </div>
          ...
          </div> <!--sidebar-box--> <?php /**PATH C:\xampp\htdocs\floorfly\resources\views/_particles/agent_widget.blade.php ENDPATH**/ ?>