                    ...
                    <div class="top-menu-container col-xs-6 col-sm-8 col-md-10">
                        <nav class="main-menu-area">
                            ...
                            <li><a href="<?php echo e(URL::to('properties/')); ?>" class="<?php echo e(classActivePathPublic('properties')); ?>"><?php echo e(trans('words.all_properties')); ?></a></li>
                                ...
                                <li class="parent">
                                <a href="<?php echo e(URL::to('agents/')); ?>" class="<?php echo e(classActivePathPublic('agents')); ?>"><?php echo e(trans('words.agents')); ?></a> 
                                <ul class="sub-menu">
...
<?php /**PATH D:\xmapp\htdocs\floorfly4\resources\views/_particles/header.blade.php ENDPATH**/ ?>