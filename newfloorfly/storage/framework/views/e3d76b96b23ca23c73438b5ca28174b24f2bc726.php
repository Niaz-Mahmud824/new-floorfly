        ...
        <table class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <?php $__currentLoopData = $allusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            	...
            	<td> <?php if($users->image_icon): ?>
								...
								<?php endif; ?></td>
                <td><a href="<?php echo e(url('admin/users/details/'.Crypt::encryptString($users->id))); ?>" class=""><?php echo e($users->name); ?></a></td>
                <td><?php echo e($users->email); ?></td>
                <td><?php echo e($users->phone); ?></td>
                <td class="text-center">
                    <?php if($users->approved=='1'): ?>
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(url('admin/users/approved/'.Crypt::encryptString($users->id))); ?>" class="btn btn-icon waves-effect waves-light btn-info m-b-5 m-r-5" data-toggle="tooltip" title="Approved"> <i class="glyphicon glyphicon-thumbs-up"></i> </a>
                    <?php endif; ?>
                 ...
                 <a href="<?php echo e(url('admin/userpdf/'.Crypt::encryptString($users->id))); ?>" class="btn btn-icon waves-effect waves-light btn-success m-b-5 m-r-5"    data-toggle="tooltip" style="float:right;" >Export Pdf</a>
