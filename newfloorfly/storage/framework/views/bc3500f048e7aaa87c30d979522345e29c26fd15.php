<?php $__env->startSection('head_title', $type.' '.trans('words.properties').' | '.getcong('site_name') ); ?>
...
<?php $__env->startSection("content"); ?>
  ...
  <section class="breadcrumb-box" data-parallax="scroll" data-image-src="<?php if(getcong('title_bg')): ?> <?php echo e(URL::asset('upload/'.getcong('title_bg'))); ?> <?php else: ?> <?php echo e(URL::asset('site_assets/img/breadcrumb-bg.jpg')); ?> <?php endif; ?>">
    <div class="inner-container container">
      <!-- <h1><?php echo e($type); ?> <?php echo e(trans('words.properties')); ?></h1>
      <div class="breadcrumb">
        <ul class="list-inline">
          <li class="home"><a href="<?php echo e(URL::to('/')); ?>"><?php echo e(trans('words.home')); ?></a></li>
          <li><?php echo e($type); ?> <?php echo e(trans('words.properties')); ?></li>
        </ul>
      </div> -->
    </div>
  </section>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/pages/propertiesbytype.blade.php ENDPATH**/ ?>