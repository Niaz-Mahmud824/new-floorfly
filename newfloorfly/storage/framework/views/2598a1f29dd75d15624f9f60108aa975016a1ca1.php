...
<?php if($paginator->lastPage() > 1): ?>
    <ul class="pagination">
        <li class="<?php echo e(($paginator->currentPage() == 1) ? ' disabled' : ''); ?>">
            <a href="<?php echo e($paginator->url(1)); ?>" style="border:none;"><i class="fa fa-angle-double-left"></i></a>
         </li>
        ...
        <li class="<?php echo e(($paginator->currentPage() == $paginator->lastPage()) ? ' disabled' : ''); ?>">
            <a href="<?php echo e($paginator->url($paginator->lastPage())); ?>" style="border:none;"><i class="fa fa-angle-double-right"></i></a>
        </li>
    </ul>
<?php endif; ?>
 <?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/admin/pagination.blade.php ENDPATH**/ ?>