            ...
            <div class="panel-body">
                <form action="<?php echo e(route('upazila.update',['id'=>$upazila->id])); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="<?php echo e(isset($upazila->name) ? $upazila->name : null); ?>" class="form-control" id="lowertxt" onkeyup="return forceLower(this);">
                        </div>
                    </div>
