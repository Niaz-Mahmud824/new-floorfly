    ...
    <div class="col-lg-9 col-md-9 min_form">
      ...
      <div class="table-responsive properties_min">
        <table class="my-properties-list">
          ...
          <?php $__currentLoopData = $interestpropertylist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
              <td class="property-img">
                 <a href="<?php echo e(url('properties/'.$property->property_slug.'/'.$property->property_id)); ?>">
                    <img src="<?php echo e(url('upload/properties/'.$property->featured_image.'-s.jpg')); ?>" alt="">
                 </a>
              </td>

              <td class="property-title">
                <a href="<?php echo e(url('properties/'.$property->property_slug.'/'.Crypt::encryptString($property->property_id))); ?>"><?php echo e($property->property_name); ?></a><br>
              ...
              <td class="property-actions">                 
                <a href="<?php echo e(url('properties/'.$property->property_slug.'/'.$property->property_id)); ?>" target="_blank"><i class="fa fa-eye icon"></i><?php echo e(trans('words.view')); ?></a>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u975246985/domains/floorfly.com/public_html/resources/views/pages/interest_properties.blade.php ENDPATH**/ ?>