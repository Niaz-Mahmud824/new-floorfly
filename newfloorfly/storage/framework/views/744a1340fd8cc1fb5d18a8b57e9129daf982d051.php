    ...
    <div class="col-xs-6 col-sm-4 col-md-3">
        <div class="agent-item">
            <div class="agent-profile">
             ...
             <div class="agent-info">
                ...
                <div class="agent-experience-data">
                  <p>Total Years of Experience : <b><?php echo e($agent->yrs_exp); ?></b></p>
                  <?php
           ...
           <?php if(!empty($education->institue)&&!empty($education->agent_result)&&!empty($education->agent_degree)): ?>
                <li> Institute: <b><?php echo e($education->institue); ?></b></li><br>
               <li>  Degree: <b><?php echo e($education->agent_degree); ?></b></li><br>
               <li>  Result: <b><?php echo e($education->agent_result); ?></b></li><br>
               <?php endif; ?>
               </ul>
